...
Version  : 3.30.1.2
Release  : 39
URL      : https://download.gnome.org/sources/gnome-settings-daemon/3.30/gnome-settings-daemon-3.30.1.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-settings-daemon/3.30/gnome-settings-daemon-3.30.1.2.tar.xz
...
Requires: gnome-settings-daemon-bin = %{version}-%{release}
Requires: gnome-settings-daemon-data = %{version}-%{release}
...
%prep
%setup -q -n gnome-settings-daemon-3.30.1.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1538747534
export AR=gcc-ar
