...
Version  : 42.1
Release  : 60
URL      : https://download.gnome.org/sources/gnome-settings-daemon/42/gnome-settings-daemon-42.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-settings-daemon/42/gnome-settings-daemon-42.1.tar.xz
...
%prep
%setup -q -n gnome-settings-daemon-42.1
cd %{_builddir}/gnome-settings-daemon-42.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647899281
...
cp %{_builddir}/gnome-settings-daemon-42.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-settings-daemon/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/gnome-settings-daemon-42.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/gnome-settings-daemon/caeb68c46fa36651acf592771d09de7937926bb3
...
%files dev
%defattr(-,root,root,-)
/usr/include/gnome-settings-daemon-42/gnome-settings-daemon/gsd-enums.h
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/gnome-settings-daemon-42/libgsd.so
