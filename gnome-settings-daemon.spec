...
Version  : 3.24.2
Release  : 15
URL      : https://download.gnome.org/sources/gnome-settings-daemon/3.24/gnome-settings-daemon-3.24.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-settings-daemon/3.24/gnome-settings-daemon-3.24.2.tar.xz
...
%prep
%setup -q -n gnome-settings-daemon-3.24.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1494351786
export AR=gcc-ar
