...
Source0  : https://download.gnome.org/sources/gnome-settings-daemon/48/gnome-settings-daemon-48.1.tar.xz
...
%prep
%setup -q -n gnome-settings-daemon-48.1
cd %{_builddir}/gnome-settings-daemon-48.1
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a gnome-settings-daemon-48.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745248015
