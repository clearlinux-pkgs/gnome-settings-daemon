...
%prep
%setup -q -n gnome-settings-daemon-46.0
cd %{_builddir}/gnome-settings-daemon-46.0
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a gnome-settings-daemon-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710894683
...
%files dev
%defattr(-,root,root,-)
/usr/include/gnome-settings-daemon-46/gnome-settings-daemon/gsd-enums.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/gnome-settings-daemon-46/libgsd.so
/usr/lib64/gnome-settings-daemon-46/libgsd.so
