...
Version  : 47.2
Release  : 92
URL      : https://download.gnome.org/sources/gnome-settings-daemon/47/gnome-settings-daemon-47.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-settings-daemon/47/gnome-settings-daemon-47.2.tar.xz
...
%prep
%setup -q -n gnome-settings-daemon-47.2
cd %{_builddir}/gnome-settings-daemon-47.2
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a gnome-settings-daemon-47.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732297425
...
%files dev
%defattr(-,root,root,-)
/usr/include/gnome-settings-daemon-47/gnome-settings-daemon/gsd-enums.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/gnome-settings-daemon-47/libgsd.so
/usr/lib64/gnome-settings-daemon-47/libgsd.so
