...
Source0  : https://download.gnome.org/sources/gnome-settings-daemon/3.38/gnome-settings-daemon-3.38.1.tar.xz
...
%prep
%setup -q -n gnome-settings-daemon-3.38.1
cd %{_builddir}/gnome-settings-daemon-3.38.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602218194
...
cp %{_builddir}/gnome-settings-daemon-3.38.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-settings-daemon/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
cp %{_builddir}/gnome-settings-daemon-3.38.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/gnome-settings-daemon/caeb68c46fa36651acf592771d09de7937926bb3
