...
Version  : 3.26.0
Release  : 17
URL      : https://download.gnome.org/sources/gnome-settings-daemon/3.26/gnome-settings-daemon-3.26.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-settings-daemon/3.26/gnome-settings-daemon-3.26.0.tar.xz
...
%prep
%setup -q -n gnome-settings-daemon-3.26.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1505343527
export AR=gcc-ar
