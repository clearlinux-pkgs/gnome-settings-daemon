...
%prep
%setup -q -n gnome-settings-daemon-45.1
cd %{_builddir}/gnome-settings-daemon-45.1
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a gnome-settings-daemon-45.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703274779
